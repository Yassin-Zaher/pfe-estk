...
const DesignConfigurator = ({
  ...
  const [rendredItem, setRendredItem] = useState("phone");
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      >
        {getComponentForValue(rendredItem)}
        <Rnd
          default={{
            x: 150,
            y: 205,
          ...
          className="absolute z-10 border-[3px] border-primary"
          lockAspectRatio
                      ...
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          ...
                          onClick={() => {
                            ...
                            handleChangeRendredImage(model.value);
                          }}
                        >
                          <Check
                            className={cn(
