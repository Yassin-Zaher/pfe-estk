...
export const handleCanvasObjectMoving = ({
  ...
  // if the selected element is an image and its src is in the imgUrls array, return
  if (target && target.type === "image" && imgUrls.includes(target.src)) {
    console.log("PREVING IMAGE FROM MOVING");
